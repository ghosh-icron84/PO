...
data <- read.delim("C:/Users/debapriyag/Desktop/TextFiles/Text.txt")
...
myCorpus = tm_map(myCorpus, removeWords,
                  c(stopwords("SMART"),"thy", "thou", "thee", "the", "and", "but", "are", "is",
                    "term","thing","these", "more","common", "closer", "current", "system", "hours",
                    "compute","that","align","for","if","simple","abound",
                    "able","about","above","abroad","according","accordingly","across","actually","adj",
                    ...
                    "doesn.t","doing","done","don.t","down","downwards","during","each","edu","eg","eight",
                    "eighty","either","else.","elsewhere","end","ending","enough","entirely","especially",
                    "et","etc","even","ever","evermore","every","everybody","everyone","everything",
                    "everywhere","ex","exactly","example","except","fairly","far","further","few","fewer",
                    ...
                    "gets","getting","given","gives","go","goes","going","gone","got","gotten","greetings","had","hadn.t","half","happens","hardly","has","
                    hasn.t","have","haven.t","having","he","he.d","he.ll","hello","help","hence","her","here","hereafter",
                    "hereby","herein","here.s","hereupon","hers","herself","he.s","hi","him","himself","his","hither","hopefully","how","howbeit","however",
                    "hundred","i.d","ie","if.","ignored","i.ll","i.m","immediate","in.","inasmuch","inc","inc.","indeed","indicate","indicated","indicates","inner",
                    "inside","insofar","instead","into","inward","is","isn.t","it","it.d","it.ll","its","it.s","itself","i.ve","just","k","keep","keeps","kept","know","known","knows","last","lately","later","latter","latterly","least","less","lest","let","let.s","like","liked","likely","likewise","little","look","looking","looks","low","lower","ltd","made","mainly","make","makes","many","may","maybe","mayn.t","me","mean","meantime","meanwhile","merely","might","mightn.t","mine","minus","miss","more","moreover","most","mostly","mr","mrs","much","must","mustn.t","my","myself","name","namely","nd","near","nearly","necessary","need","needn.t","needs","neither","never","neverf","neverless","nevertheless","new","next.","nine","ninety","no","nobody","non","none","nonetheless","noone","no.one","nor","normally","not","nothing","notwithstanding","novel","now","nowhere","obviously","of","off","often","oh","ok",
...
tdm = TermDocumentMatrix(myCorpus,
                         control = list(minWordLength = 8))

m = as.matrix(tdm)
freq <- colSums(as.matrix(tdm))   
length(freq)  
ord <- order(freq)
dtms <- removeSparseTerms(tdm, 0.1)
dt <- inspect(dtms) 
freq[head(ord)]  
n = as.matrix(dt)
words <- sort(rowSums(n), decreasing = TRUE)
finalwords <- head(words,8)
names(unique(finalwords))
