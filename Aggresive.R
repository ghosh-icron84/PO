...
#---------------------------------------------------------------------------#
setwd("C:/Users/debapriyag/Desktop/Portfolio Opt_2018/Code/Aggressive_18/Codes")
source(file="UsefulFunctionsQ2_18.R")
#------------------- Part A ends   ---------------------------------------------#
...
#------------------- Part C starts ---------------------------------------------#
myPF_CumReturns(myPFstrList = c("optAPF3_1h6mo", "optAPF3_1h1yr"), bmRet = bmeqt, prefix="Aggressive")
#------------------- Part C ends   ---------------------------------------------#
...
myPF_QrtReturns(myPFstrList = c("optAPF3_1h6mo", "optAPF3_1h1yr"),
                ttl = "Comparing Quarterly Returns for APF3 (@H= 1yr, 6mo)",bmRet = bmeqt, prefix="Aggressive")
...
#------------------- Part E starts ---------------------------------------------#
myPF_Overall_Performance(myPFstrList = c("optAPF3_1h6mo", "optAPF3_1h1yr"),ttl = "Overall Performance of APF3 (@H= 1yr, 6mo)",
                         risk = "SD",	bmRet = bmeqt , prefix="Aggressive")

myPF_Overall_Performance(myPFstrList = c("optAPF3_1h6mo", "optAPF3_1h1yr"),ttl = "Overall Performance of APF3 (@H= 1yr, 6mo)",
                         risk = "CVaR",	bmRet = bmeqt , prefix="Aggressive")

myPF_Overall_Performance(myPFstrList = c("optAPF3_1h6mo", "optAPF3_1h1yr"),ttl = "Overall Performance of APF3 (@H= 1yr, 6mo)",
                         risk = "MaxDrawDown",	bmRet = bmeqt , prefix="Aggressive")
