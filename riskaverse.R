...
#-------------------------------------------------------------------------------#
setwd("C:/Users/debapriyag/Desktop/Portfolio Opt_2018/Code/RiskAverse_18/Codes")
source(file="UsefulFunctionsV3_18.R")
...
#-------------------------------------------------------------------------------#
SMart_Wrapper_ConservativeOptPF(hor = 12, group = 4.1, method = "Basic", token = "optCPF3_1h1yr")
SMart_Wrapper_ConservativeOptPF(hor =  6, group = 4.1, method = "Basic", token = "optCPF3_1h6mo")
